 ...
 * пропуска в цитате (C-08), кроссворд (C-09), заклинивший замок (C-14, без отмычки: везде метафора замка) и свеча пророка (C-15).
...
/* ---------- Замок заклинило и свеча пророка ---------- */

/** Заклинивший замок: кольцо-таймер с точным временем рядом (метафора не прячет время). */
