...
export function GamesPage() {
  ...
  return (
    <>
      ...
      <div className="home-foot"><Link to="/how-to-play" className="btn secondary"><Icon name="help" />{t("Как играть?")}</Link><Link to="/whats-new" className="btn ghost"><Icon name="sparkle" />{t("Что нового")}</Link><Link to="/games/new" className="btn ghost"><Icon name="plus" />{t("Создать игру")}</Link></div>
    </>
  );
}
