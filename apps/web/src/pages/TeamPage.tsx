        ...
        <div className="card">
          ...
          {map.status === "FINISHED" ? (
            ...
            <>
              ...
              {isCaptain && <p className="muted mt-2">{t("Раздайте роли всем участникам: они дают команде разведку, подсказки и переговоры. Пока у кого-то нет роли, администратор не сможет начать игру.")}</p>}
