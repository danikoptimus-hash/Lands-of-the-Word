...
export const ADMIN: Record<string, string> = {
  ...
  "Можно издалека: подходит уехавшему или болеющему; такое дело всегда есть среди свободных сторон": "From afar: suits someone away or ill; such a deed is always among the free sides",
  ...
  "Игра сама выберет случайный концевой участок пути команды и аннулирует его: перекрёсток за ним закроется, дело придётся сделать заново. Города и старт не трогаются.": "The game will pick a random end segment of the team's path and annul it: the crossing beyond it closes and the deed has to be done again. Cities and the start are untouched.",
  ...
  "Игровые роли — только у участников: капитан ведёт команду. Роль, запрошенную капитаном, одобрите здесь; сами вы ставите роли сразу.": "Game roles are for members only: the captain leads the team. Approve roles requested by the captain here; roles you set yourself apply at once.",
  "Продвинутые настройки": "Advanced settings",
  "Правила игры в числах. Значения по умолчанию подобраны для сезона; меняйте, только если понимаете, зачем. Идущие испытания доигрываются по прежним срокам.": "The game rules in numbers. Defaults are tuned for a season; change them only if you know why. Running trials finish on their previous deadlines.",
  "Минимальная ставка вызова, стихов": "Minimum challenge stake, verses", "Срок вызова, дней": "Challenge duration, days", "Штраф за сгоревший вызов, стихов": "Penalty for an expired challenge, verses",
  "Минимальное время ответа, секунд": "Minimum answer time, seconds", "Срок ответа на запрос прохода, дней": "Time to answer a passage request, days", "Закрепление после отбитого максимума, недель": "Sealing after a repelled maximum, weeks",
  "Усталость города: дней без дел до убыли": "City fatigue: days without deeds before decay", "Усталость: убыль раз во сколько дней": "Fatigue: decay every N days", "Усталость: на сколько стихов за шаг": "Fatigue: verses per step",
  "Взятое дело возвращается в список через, дней": "A taken deed returns to the list after, days", "Смена ролей не чаще раза в, дней": "Role changes no more often than once per, days", "Ход разведчика и пророка раз в, дней": "Scout and prophet move once per, days",
  "Осада делами, дней": "Siege by deeds, days", "Баллов за дело при осаде": "Points per deed in a siege", "Растущая пауза после неверного ответа, секунды по ступеням": "Growing pause after a wrong answer, seconds per step",
  "После старта можно менять только пожертвование и правила: карта и команды зафиксированы.": "After the start only the donation and the rules can be changed: the map and teams are fixed.",
  "Штраф за телефон на собрании: в блоке «Команды» у команды есть действие «Оштрафовать» — игра сама выбирает случайный концевой участок пути и аннулирует его. Там же администратор одобряет роли, запрошенные капитаном, и переводит участников между командами. В «Настройках» есть «Продвинутые настройки»: минимальная ставка, сроки, штрафы, паузы и другие числа правил.": "Penalty for a phone at the meeting: in the “Teams” block a team has a “Penalize” action — the game picks a random end segment of the path and annuls it. There the administrator also approves roles requested by the captain and moves members between teams. “Settings” has “Advanced settings”: the minimum stake, deadlines, penalties, pauses and other rule numbers.",
};
