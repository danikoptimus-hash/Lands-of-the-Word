...
export const ADMIN: Record<string, string> = {
  ...
  "Команды и приглашения": "Teams and invitations", "Адресаты конвертов и ярлыки": "Envelope recipients and labels", "Можно и после старта": "Can be added after the start too",
  ...
  "Роли — у участников, не у капитана. Запрос капитана одобрите здесь; ваш выбор применяется сразу.": "Roles belong to members, not the captain. Approve the captain's request here; your own choice applies at once.",
  ...
  "Повторяемое": "Repeatable", "Можно выдавать нескольким командам.": "Can be given to several teams.", "одно на игру": "one per game", "книга": "book", "книг": "books", "лёгкое": "easy", "среднее": "medium", "трудное": "hard",
  // Адресаты
  ...
  "Обращений нет.": "No requests.", "попыток осталось {n}": "attempts left {n}", "закрыто до {d}": "locked until {d}",
