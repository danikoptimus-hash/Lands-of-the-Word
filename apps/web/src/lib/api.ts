...
export type JournalKind = "deed_submitted" | "deed_approved" | "deed_returned" | "order_solved" | "task_solved" | "city_captured" | "ruins_taken" | "treasure" | "trial_declared" | "trial_queued" | "trial_started" | "trial_repelled" | "trial_won" | "trial_burnt" | "trial_cancelled" | "siege_declared" | "siege_won" | "siege_repelled" | "passage_granted" | "passage_denied" | "sea_landed" | "penalty" | "role_changed" | "capital_moved" | "peace_offered" | "peace_made" | "peace_declined" | "peace_broken" | "chronicle" | "game_finished";
export interface FeedItemDto { id: string; kind: JournalKind; vars: Record<string, string | number>; text: string; everyone: boolean; mine?: boolean; at: number }
